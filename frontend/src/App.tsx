    ...
    <div className="min-h-screen bg-slate-50 flex flex-col">
      ...
      <header className="bg-white border-b border-slate-200 px-6 py-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-sm font-semibold text-slate-900">Convertidor de imágenes</h1>
            <p className="text-xs text-slate-400">Convierte entre WebP · PNG · JPEG · AVIF · GIF</p>
          </div>
        </div>
      ...
      <main className="flex-1 max-w-4xl w-full mx-auto px-6 py-8 flex flex-col gap-4">
        ...
        <button
          ...
          className="w-full py-3 bg-slate-900 text-white font-medium rounded-xl
                     ...
                     hover:bg-slate-700 active:scale-[0.99] transition-all duration-100
